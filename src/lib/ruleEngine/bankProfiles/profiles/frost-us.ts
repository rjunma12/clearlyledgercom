/**
 * Frost Bank US Profile
 * Texas regional bank
 */

import type { BankProfile } from '../types';

export const frostUsProfile: BankProfile = {
  id: 'frost-us',
  name: 'Frost Bank',
  region: 'US',
  defaultLocale: 'en-US',
  identification: {
    logoPatterns: ['FROST BANK', 'FROST', 'frostbank.com', 'CULLEN/FROST'],
    accountPatterns: [/\b\d{10,12}\b/],
    uniqueIdentifiers: ['FRSTUS44', 'FRSTBNK'],
